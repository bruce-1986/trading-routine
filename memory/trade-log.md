...
| Symbol | Kaufdatum  | Kaufkurs    | Close 20.07. 16:02 ET  | Gewinn/Verlust        | Stop-Loss       | TP1         | TP2         | Signale         |
|--------|------------|-------------|------------------------|-----------------------|-----------------|-------------|-------------|-----------------|
| UNH    | 2026-06-18 | 401,57 $    | 421,85 $               | +454,32 $ (+5,05 %)   | 369,44 $ ✓Reset | 481,88 $    | 542,12 $    | V1-V6 SICHER (Puffer +14,19 %, leicht verschlechtert vs Midday +14,28 %) |
| AAPL   | 2026-07-13 | 316,86 $    | 326,65 $               | +309,49 $ (+3,09 %)   | 291,51 $        | 380,23 $    | 427,76 $    | V1-V6 SICHER (Puffer +12,05 %, verbessert vs Midday +11,37 % durch weiteren Chg -2,07 %, XLK-Divergenz-Muster Fortsetzung) |
| JPM    | 2026-06-17 | 332,78 $    | 338,90 $               | +18,27 $ (+1,84 %)    | 306,16 $        | 399,34 $    | 449,25 $    | V1-V6 SICHER (Puffer +10,69 %, verschlechtert vs Midday +10,95 %) |
| LLY    | 2026-07-06 | 1.193,89 $  | 1.146,38 $             | -380,14 $ (-3,98 %)   | 1.098,38 $      | 1.432,66 $  | 1.611,75 $  | V1-V6 SICHER (Puffer **+4,37 %**, deutlich verschlechtert vs Midday +6,15 % um -1,78 pp, Chg -2,78 % schlechteste heute, RSI 47,72 unter 50 gekippt = Momentum-Neutralisierung, XLV-Watch Di) |
| **GOOGL**| 2026-07-07 | 368,10 $  | 352,11 $               | -409,73 $ (-4,28 %)   | **338,65 $** (Blackout Option A: Owner-Freigabe pending) | 441,72 $ | 496,93 $    | V1-V6 SICHER (Puffer **+3,97 %**, leicht verschlechtert vs Midday +4,36 %, Blackout V1_neu 349,70 < Kurs = +0,69 % positiv → kein Sofort-Stop-Risiko, RS_4w -3,68 %) |
| **GS** | 2026-07-15 | 1.141,74 $  | 1.055,66 $             | -693,71 $ (-7,60 %)   | **1.050,40 $** | 1.370,09 $  | 1.541,35 $  | V1-V6 SICHER **RAZOR-THIN** (Puffer **+0,50 % ENGSTE ALLER ZEITEN**, marginal verbessert vs Midday +0,41 %, Fill-Day+3 Drop-Muster VOLLBILD, 5,26 $ vom V1, RS_4w -3,15 %) |
| **V** (NEU) | 2026-07-20 | 357,18 $ | 361,05 $               | +91,59 $ (+1,09 %)    | 328,60 $        | 428,62 $    | 482,20 $    | V1-V6 SICHER (Fill-Day+0 Close +1,09 % — **kein Sofort-Drop-Muster** wie AVGO/MU/GS bestätigt; V5 EMA-Spread +3,67 marginal aber Golden Cross intakt; RSI 64,29 stark) |

**Gesamt investiert:** 57.750,94 $ (Marktwert 16:02 ET) | **Cash:** 40.026,28 $ | **Positionen:** 7/8 | **Käufe KW30:** 1/2 (V 20.07., Slot 2/2 verfügbar bis Fr 24.07.)
...
_Keine offenen Orders — Alle V5/V6 SICHER, KEINE Limit-Order für Di 21.07. platziert._
