...
| Symbol | Kaufdatum  | Kaufkurs    | Live 16.07. 09:37 ET   | Gewinn/Verlust        | Stop-Loss       | TP1         | TP2         | Signale         |
|--------|------------|-------------|------------------------|-----------------------|-----------------|-------------|-------------|-----------------|
| **UNH**| 2026-06-18 | 401,57 $    | **451,75 $**           | **+1.204,32 $ (+12,50 %)** | **369,44 $** ✓Reset | 481,88 $ | 542,12 $ | V1-V6 SICHER (**Q2-BEAT chg +7,94 % Rally**, V1-Reset 381,49→369,44 nach Post-Release, Puffer **+22,28 %**) |
| JPM    | 2026-06-17 | 332,78 $    | 342,34 $               |  +28,68 $ (+2,87 %)   | 306,16 $        | 399,34 $    | 449,25 $    | V1-V6 SICHER (chg -1,32 % mildes Give-back nach Post-Q2-Rally 3 Tage, +11,82 % Puffer) |
| LLY    | 2026-07-06 | 1.193,89 $  | 1.145,99 $             | -383,20 $ (-4,01 %)   | 1.098,38 $      | 1.432,66 $  | 1.611,75 $  | V1-V6 SICHER (**engste +4,33 %**, chg -0,92 % Reversal Tag 2 pausiert, RSI-Watch) |
| GOOGL  | 2026-07-07 | 368,10 $    | 371,17 $               |  +79,82 $ (+0,83 %)   | 338,65 $        | 441,72 $    | 496,93 $    | V1-V6 SICHER (+9,61 %, chg +0,07 % stabil, GOOGL-Blackout ab Fr 17.07. Close aktivierbar) |
| AAPL   | 2026-07-13 | 316,86 $    | 328,00 $               | +345,34 $ (+3,52 %)   | 291,51 $        | 380,23 $    | 427,76 $    | V1-V6 SICHER (chg +0,15 % Konsolidierung nach Mi-Rebell +4,08 %, +12,52 %) |
| **GS** | 2026-07-15 | 1.141,74 $  | 1.126,96 $             | -118,26 $ (-1,29 %)   | **1.050,40 $**  | 1.370,09 $  | 1.541,35 $  | V1-V6 SICHER (**Fill-Day+1 Drop-Muster ausgelöst** chg -2,18 %, +7,29 % Puffer noch komfortabel) |

**Gesamt investiert:** 49.515,43 $ (Marktwert Alpaca Live 16.07. 13:07 ET) | **Cash:** 49.670,08 $ | **Positionen:** 6/8 | **Käufe KW29:** 2/2 LOCK (AAPL 13.07. + GS 15.07., bis Mo 20.07. KW30)
