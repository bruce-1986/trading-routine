...
| Symbol | Kaufdatum  | Kaufkurs    | Live 20.07. 13:08 ET   | Gewinn/Verlust        | Stop-Loss       | TP1         | TP2         | Signale         |
|--------|------------|-------------|------------------------|-----------------------|-----------------|-------------|-------------|-----------------|
| UNH    | 2026-06-18 | 401,57 $    | 422,20 $               | +495,12 $ (+5,14 %)   | 369,44 $ ✓Reset | 481,88 $    | 542,12 $    | V1 SICHER (Puffer +14,28 %, verbessert vs Open +14,08 %) |
| AAPL   | 2026-07-13 | 316,86 $    | 324,64 $               | +241,29 $ (+2,46 %)   | 291,51 $        | 380,23 $    | 427,76 $    | V1 SICHER (Puffer +11,37 %, verschlechtert vs Open +13,64 %) |
| JPM    | 2026-06-17 | 332,78 $    | 339,68 $               | +20,68 $ (+2,07 %)    | 306,16 $        | 399,34 $    | 449,25 $    | V1 SICHER (Puffer +10,95 %, verschlechtert vs Open +12,16 %) |
| LLY    | 2026-07-06 | 1.193,89 $  | 1.165,96 $             | -223,42 $ (-2,34 %)   | 1.098,38 $      | 1.432,66 $  | 1.611,75 $  | V1 SICHER (Puffer +6,15 %, verschlechtert vs Open +6,93 %) |
| **GOOGL**| 2026-07-07 | 368,10 $  | 353,43 $               | -381,39 $ (-3,99 %)   | **338,65 $** (Blackout Option A: Owner-Freigabe pending) | 441,72 $ | 496,93 $    | V1 SICHER (Puffer +4,36 %, verschlechtert vs Open +5,35 %) |
| **GS** | 2026-07-15 | 1.141,74 $  | 1.054,76 $             | -695,87 $ (-7,62 %)   | **1.050,40 $** | 1.370,09 $  | 1.541,35 $  | V1 SICHER **RAZOR-THIN** (Puffer **+0,41 % ENGSTE ALLER ZEITEN**, verschlechtert vs Open +2,80 %, Fill-Day+3 Drop-Muster VOLLBILD, 4,36 $ vom V1) |
| **V** (NEU) | 2026-07-20 | 357,18 $ | 360,89 $               | +100,23 $ (+1,04 %)   | 328,60 $        | 428,62 $    | 482,20 $    | V1 SICHER (Fill-Day+0 +1,04 %, Puffer +9,83 %, **kein Sofort-Drop-Muster** wie AVGO/MU) |

**Gesamt investiert:** 57.914,63 $ (Marktwert 13:08 ET) | **Cash:** 40.026,28 $ | **Positionen:** 7/8 | **Käufe KW30:** 1/2 (V 20.07., Slot 2/2 verfügbar bis Fr 24.07.)
...
_Keine offenen Orders — Alle V5/V6 SICHER, keine Limit-Order für Mo 20.07. platziert._
