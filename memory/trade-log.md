...
| Symbol | Kaufdatum  | Kaufkurs    | Close 21.07. 16:03 ET  | Gewinn/Verlust        | Stop-Loss       | TP1         | TP2         | Signale         |
|--------|------------|-------------|------------------------|-----------------------|-----------------|-------------|-------------|-----------------|
| UNH    | 2026-06-18 | 401,57 $    | 437,00 $               | +850,32 $ (+8,82 %)   | 369,44 $ ✓Reset | 481,88 $    | 542,12 $    | V1-V6 SICHER (Puffer **+18,29 %**, deutlich verbessert vs Mo +14,19 %, **beste Chg heute +3,67 %**, beste P/L Portfolio) |
| JPM    | 2026-06-17 | 332,78 $    | 345,00 $               | +36,66 $ (+3,67 %)    | 306,16 $        | 399,34 $    | 449,25 $    | V1-V6 SICHER (Puffer +12,69 %, verbessert vs Mo +10,69 %) |
| AAPL   | 2026-07-13 | 316,86 $    | 327,305 $              | +323,90 $ (+3,30 %)   | 291,51 $        | 380,23 $    | 427,76 $    | V1-V6 SICHER (Puffer +12,28 %, leicht verbessert vs Mo +12,05 %, XLK-Divergenz-Watch entspannt heute) |
| V      | 2026-07-20 | 357,18 $    | 355,82 $               | -36,66 $ (-0,38 %)    | 328,60 $        | 428,62 $    | 482,20 $    | V1-V6 SICHER (Puffer +8,28 %, Fill-Day+1 Chg -1,32 % Konsolidierung, V5 EMA-Spread +4,17 marginal aber Golden Cross intakt, RSI ~63) |
| LLY    | 2026-07-06 | 1.193,89 $  | 1.174,80 $             | -152,70 $ (-1,60 %)   | 1.098,38 $      | 1.432,66 $  | 1.611,75 $  | V1-V6 SICHER (Puffer +6,96 %, **REBOUND +2,43 % chg** vs Mo -2,78 %, RSI ~49 XLV-Watch bleibt aber Momentum stabilisiert) |
| **GS** | 2026-07-15 | 1.141,74 $  | 1.085,56 $             | -449,47 $ (-4,92 %)   | **1.050,40 $** | 1.370,09 $  | 1.541,35 $  | V1-V6 SICHER (Puffer **+3,35 %**, **REBOUND-TAG +2,89 % chg** vs Mo +0,50 %, Fill-Day+4-Muster AVGO/MU-Präzedenz **überwunden**, 35,16 $ vom V1) |
| **GOOGL**| 2026-07-07 | 368,10 $  | 347,36 $               | -539,21 $ (-5,63 %)   | **338,65 $** (Blackout Option A: Owner-Freigabe LETZTE CHANCE Mi Vormittag) | 441,72 $ | 496,93 $    | V1-V6 SICHER **ENGSTE** (Puffer **+2,57 %**, deutlich verschlechtert vs Mo +3,97 %, Blackout V1_neu 349,70 > Kurs = **-0,67 % negativ** → Aktivierung würde Sofort-Stop, RS_4w -3,68 %) |

**Gesamt investiert:** 58.379,80 $ (Marktwert 09:40 ET Live) | **Cash:** 40.026,27 $ | **Positionen:** 7/8 | **Käufe KW30:** 1/2 (V 20.07., Slot 2/2 verfügbar bis Fr 24.07.)
...
_Keine offenen Orders — Alle V5/V6 SICHER, KEINE Limit-Order für Mi 22.07. platziert._
