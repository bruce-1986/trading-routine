...
| Symbol | Kaufdatum  | Kaufkurs    | Close 16.07. 16:02 ET  | Gewinn/Verlust        | Stop-Loss       | TP1         | TP2         | Signale         |
|--------|------------|-------------|------------------------|-----------------------|-----------------|-------------|-------------|-----------------|
| UNH    | 2026-06-18 | 401,57 $    | 421,14 $               | +469,68 $ (+4,87 %)   | 369,44 $ ✓Reset | 481,88 $    | 542,12 $    | V1-V6 SICHER (**Post-Rally-Give-back** von TH 460,95 auf 421,14 = -8,64 %, aber Puffer +13,99 %, V2 auf **405,64** trailt) |
| AAPL   | 2026-07-13 | 316,86 $    | **332,81 $**           | **+494,56 $ (+5,04 %)**| 291,51 $       | 380,23 $    | 427,76 $    | V1-V6 SICHER (**Tages-Sieger**, chg +1,62 %, RSI 72,02 höchste aber <80, V2 auf 294,49 trailt, +14,17 %) |
| JPM    | 2026-06-17 | 332,78 $    | 343,15 $               | +31,11 $ (+3,12 %)    | 306,16 $        | 399,34 $    | 449,25 $    | V1-V6 SICHER (chg -1,08 % Give-back Post-Q2 Tag 3, V2 auf 306,97 trailt, +12,08 %) |
| LLY    | 2026-07-06 | 1.193,89 $  | 1.170,50 $             | -187,10 $ (-1,96 %)   | 1.098,38 $      | 1.432,66 $  | 1.611,75 $  | V1-V6 SICHER (Reversal-Fortsetzung chg +1,20 %, +6,57 % Puffer, RSI 53,18) |
| **GOOGL**| 2026-07-07 | 368,10 $  | **354,87 $**           | **-343,95 $ (-3,59 %)**| 338,65 $ (Fr→349,70) | 441,72 $ | 496,93 $    | V1-V6 SICHER (**Nachmittags-Kollaps** chg -4,33 %, +4,79 % Puffer, Blackout-Tightening Fr Close) |
| **GS** | 2026-07-15 | 1.141,74 $  | **1.095,46 $**         | **-370,27 $ (-4,05 %)**| **1.050,40 $** | 1.370,09 $  | 1.541,35 $  | V1-V6 SICHER (**Fill-Day+1 Drop VOLLBILD** chg -4,91 %, **+4,29 % Puffer ENGSTE**, Muster AVGO/MU) |

**Gesamt investiert:** 48.726,53 $ (Marktwert Alpaca Live 17.07. 13:07 ET) | **Cash:** 49.670,08 $ | **Positionen:** 6/8 | **Käufe KW29:** 2/2 LOCK (AAPL 13.07. + GS 15.07., bis Mo 20.07. KW30)
...
_Keine offenen Orders — Alle V5/V6 SICHER, keine Limit-Order für Fr 17.07. platziert._

_Market Close 16.07. 16:02 ET: **V5/V6-Check alle 6 SICHER** (EMA50>EMA200 überall, RSI max 72,02 AAPL <<80-Threshold; GOOGL RSI 46,25 + RS_4w -5,40 % erfüllt V6-Teilbedingung, aber V6 verlangt BEIDES → nicht ausgelöst). **Keine Limit-Order für Fr 17.07.** platziert. **Pre-Market Fr 08:30 ET kritischer Watch:** GS V1 1.050,40 (Puffer 4,29 % ENGSTE, Fill-Day+1-Drop-Muster VOLLBILD), GOOGL V1 338,65 (Puffer 4,79 %, Nachmittags-Kollaps). **GOOGL-Blackout aktivierbar ab Fr 17.07. Close** (Q2 am 22.07. AMC) → V1-Tightening 338,65 → 349,70 (-5 % = 368,10×0,95) zwingend bei Close-Routine morgen. Weekly Loss Cap KW29 Tag 4 = -0,143 % [GRÜN, Cap -5 % weit entfernt] → keine Weekly-Cap-Aktion._

_**V5/V6 Signal-Details alle 6 SICHER (Alpaca 262d Bars, Wilder EMA/RSI):** AAPL EMA50 298,93 > EMA200 272,73 ✓ (Spread +26,20), RSI 72,02 höchste (<80), RS_4w +11,05 %; JPM EMA50 321,60 > EMA200 307,63 ✓ (Spread +13,97), RSI 63,11, RS_4w +3,78 %; UNH EMA50 397,07 > EMA200 347,97 ✓ (Spread +49,10), RSI 56,53, RS_4w +3,46 %; LLY EMA50 1114,75 > EMA200 986,06 ✓ (Spread +128,69), RSI 53,18, RS_4w +3,94 %; GOOGL EMA50 359,24 > EMA200 315,46 ✓ (Spread +43,78), RSI 46,25, RS_4w -5,40 % (V6 verlangt BEIDES → nicht ausgelöst); GS EMA50 1025,42 > EMA200 904,07 ✓ (Spread +121,35), RSI 56,71, RS_4w +0,23 %._
